function validarProduto(produto, ID, quantidade) {
    let nome = document.getElementById(produto).value;
    let codigo = document.getElementById(ID).value;
    let qtidade = document.getElementById(quantidade).value;
...
function cadastrarProduto(produto, ID, quantidade) {
    let novoProduto = {nome:produto, codigo:ID, quantidade:quantidade};
